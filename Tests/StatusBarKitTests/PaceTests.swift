...
@Test func paceLabelTexty() {
    ...
    #expect(PaceLabel.text(deltaPercent: 20, bundle: cs) == "skluz 20 %")
    #expect(PaceLabel.text(deltaPercent: -42, bundle: cs) == "rezerva 42 %")
    #expect(PaceLabel.text(deltaPercent: 0, bundle: cs) == "rovnoměrné tempo")
    #expect(PaceLabel.text(deltaPercent: 20, bundle: en) == "20% over")
    #expect(PaceLabel.text(deltaPercent: -42, bundle: en) == "42% buffer")
